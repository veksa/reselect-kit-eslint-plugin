...
ruleTester.run('no-different-props-without-autofix', noDifferentPropsRule, {
  invalid: [
    {
      code: stripIndent`
...
ruleTester.run('require-key-selector-without-autofix', requireKeySelectorRule, {
  invalid: [
    {
      code: stripIndent`
import {createCachedSelector} from '@veksa/re-reselect';
...
ruleTester.run('no-different-props-unrelated-calls', noDifferentPropsRule, {
  valid: [
...
ruleTester.run('no-different-props-union-options', noDifferentPropsRule, {
  valid: [
    {
      code: stripIndent`
import {createCachedSelector} from '@veksa/re-reselect';
