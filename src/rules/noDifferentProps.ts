    ...
    CallExpression(callExpression) {
      ...
      if (isCachedSelectorCreator(tsNode, typeChecker)) {
        ...
        if (keySelector && keySelector.valueDeclaration) {
          ...
          const keySelectorProps = getSelectorProps(keySelectorType, typeChecker);
          const cachedSelectorProps = getCachedSelectorProps(tsNode, typeChecker);
          ...
          if (areParametersDifferent(selectorParameters, keySelectorParameters, typeChecker)) {
            context.report({
              ...
              fix(fixer: any) {
                ...
                const propSelectors = selectorParameters.map(getPropSelectorText);
